run_app:
	...
	wget -r http://127.0.0.1:8050/_dash-component-suites/dash/dash_table/async-slider.js
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|dash-magnetic-signal\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|dash-magnetic-signal/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|dash-magnetic-signal/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|dash-magnetic-signal/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|dash-magnetic-signal/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|dash-magnetic-signal/assets|g' {} \;
